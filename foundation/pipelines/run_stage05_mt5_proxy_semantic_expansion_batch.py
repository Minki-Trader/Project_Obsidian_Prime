...
REFERENCE_LABELS = {
    ...
    "05AI_trend_proxy_light_pb_0001": "existing_light_pb",
    "05AH_trend_proxy_sector_replacement_0001": "existing_full_proxy",
    "05AJ_trend_proxy_light_vb_0001": "existing_light_vb",
}
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run broader semantic proxy variants on top of the 05W feature-side base.")
...
def build_specs() -> list[ProxySpec]:
    return [
        ProxySpec(
            stage_id="05BB",
            run_name="05BB_trend_proxy_persistence_only_0001",
            experiment_id="exp_05bb_trend_proxy_persistence_only_v1",
            review_basename="05BB_mt5_model_family_trial_review",
            variant_label="persistence_only",
            component_groups=["trend_proxy_persistence"],
        ),
        ProxySpec(
            stage_id="05BC",
            run_name="05BC_trend_proxy_breakout_only_0001",
            experiment_id="exp_05bc_trend_proxy_breakout_only_v1",
            review_basename="05BC_mt5_model_family_trial_review",
            variant_label="breakout_only",
            component_groups=["trend_proxy_breakout_pressure"],
        ),
        ProxySpec(
            stage_id="05BD",
            run_name="05BD_trend_proxy_volatility_only_0001",
            experiment_id="exp_05bd_trend_proxy_volatility_only_v1",
            review_basename="05BD_mt5_model_family_trial_review",
            variant_label="volatility_only",
            component_groups=["trend_proxy_volatility_regime"],
        ),
        ProxySpec(
            stage_id="05BE",
            run_name="05BE_trend_proxy_breadth_only_0001",
            experiment_id="exp_05be_trend_proxy_breadth_only_v1",
            review_basename="05BE_mt5_model_family_trial_review",
            variant_label="breadth_only",
            component_groups=["trend_proxy_breadth_confirmation"],
        ),
        ProxySpec(
            stage_id="05BF",
            run_name="05BF_trend_proxy_persistence_volatility_0001",
            experiment_id="exp_05bf_trend_proxy_persistence_volatility_v1",
            review_basename="05BF_mt5_model_family_trial_review",
            variant_label="persistence_volatility_pair",
            component_groups=["trend_proxy_persistence", "trend_proxy_volatility_regime"],
        ),
        ProxySpec(
            stage_id="05BG",
            run_name="05BG_trend_proxy_breakout_breadth_0001",
            experiment_id="exp_05bg_trend_proxy_breakout_breadth_v1",
            review_basename="05BG_mt5_model_family_trial_review",
            variant_label="breakout_breadth_pair",
            component_groups=["trend_proxy_breakout_pressure", "trend_proxy_breadth_confirmation"],
        ),
    ]


def run_trial(spec: ProxySpec, args: argparse.Namespace, *, run_holdout: bool) -> None:
    cmd = [
        sys.executable,
...
def extract_payload(view: BundleView, spec: ProxySpec | None, label: str) -> dict[str, Any]:
...
def build_review_payload(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "phase": "05BH_mt5_proxy_semantic_expansion_batch",
    ...
    if ranked_holdout is not None:
        ...
        if holdout_winner not in REFERENCE_RUN_NAMES and validation_winner == holdout_winner:
            payload["verdict"] = {
                ...
                "reason": "new semantic proxy variant led both validation and holdout across the current feature-side frontier",
            }
            ...
            payload["verdict"] = {
                ...
                "selected_run_name": incumbent_name,
                "reason": "no new semantic proxy variant cleared the current feature-side frontier on holdout",
            }
    else:
        payload["verdict"] = {
...
def update_review_index(review_dir: Path) -> None:
    ...
    entry = "- `05BH`: see `05BH_mt5_proxy_semantic_expansion_review.md`"
...
def main() -> int:
    ...
    review_json_path = review_dir / "05BH_mt5_proxy_semantic_expansion_review.json"
    review_md_path = review_dir / "05BH_mt5_proxy_semantic_expansion_review.md"
