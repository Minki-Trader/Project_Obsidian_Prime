...
def build_status_history() -> list[StatusEvent]:
    now = utc_now_iso()
    return [
        StatusEvent(status="draft", changed_at_utc=now, reason="bundle_initialized_from_stage35_bridge_reference"),
        StatusEvent(status="ready", changed_at_utc=now, reason="stage37_long_horizon_bridge_wave1_prepared"),
    ]


RUNS = [
    {
        "folder_name": "37A_34d_bridge_0001",
        "experiment_id": "exp_37a_34d_bridge_v1",
        "stage_id": "37A",
        "base_key": "35A",
        "extra_overrides": {
            "stage37_bridge_label": "34d_continuous_bridge",
            "stage37_bridge_mode": "operating_reference_continuity",
        },
    },
    {
        "folder_name": "37B_34b_bridge_0001",
        "experiment_id": "exp_37b_34b_bridge_v1",
        "stage_id": "37B",
        "base_key": "35B",
        "extra_overrides": {
            "stage37_bridge_label": "34b_governance_only_bridge",
            "stage37_bridge_mode": "simplification_shadow_continuity",
        },
    },
]
...
def main() -> int:
    ...
    for run in RUNS:
        ...
        bundle.identity.stage_name = "long_horizon_bridge_read"
