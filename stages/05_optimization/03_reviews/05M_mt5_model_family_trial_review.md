# 05M Stage 05 Model Family Trial Review

Generated at: `2026-03-29T16:00:07.086390+00:00`

## Scope

- purpose: `train a fresh extra_trees model on the frozen h/band dataset and run the current 03E logic on MT5`
...
- trial model test: macro_f1=`0.1951`, balanced_accuracy=`0.3543`, accuracy=`0.2173`, log_loss=`1.4092`

## MT5 Validation Ranking

- [1] `05M_et_margin_swap_0001`: return_pct=422.012, profit_factor=11.5836, max_dd_pct=2.0969, ulcer_index=0.2712, trades=449, ready_gap=0, unexpected_skips=0
...
- validation leader: `05M_et_margin_swap_0001`
